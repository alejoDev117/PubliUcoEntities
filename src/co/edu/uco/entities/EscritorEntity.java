...
public class EscritorEntity {
	...
	public EscritorEntity(UUID identificador, TipoIdentificacionEntity tipoIdentificacion, String numeroIdentificacion,
			...
			boolean numeroTelefonoMovilEstaVerificado, EstadoEscritorEntity estado) {
		super();
	...
	public static final EscritorEntity getDefaultObject() {

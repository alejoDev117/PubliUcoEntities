...
public class RevisorEntity {
	...
	public RevisorEntity(UUID identificador, TipoIdentificacionEntity tipoIdentificacion, String numeroIdentificacion,
			...
			boolean numeroTelefonoMovilEstaVerificado, EstadoRevisorEntity estado) {
		super();
	...
	public static final RevisorEntity getDefaultObject() {
	...
	private final void setEstado(EstadoRevisorEntity estado) {
